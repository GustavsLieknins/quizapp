    ...
    <div class="flex justify-center items-center min-h-screen ">
        <div class="shadow-lg rounded-lg p-10 max-w-lg text-center" style="background-color: rgb(66, 66, 66);">
            ...
            <p class="text-gray-300 mb-6">
                Must komanda kuru vadīja Gustavs un mūsu labākie programmētāji kā Matiss, Elvis, Kristaps un mūsu special needs komandas biedrs Marsmelis izveidoja šo mājas lapu.
            </p>
