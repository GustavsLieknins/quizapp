    ...
    <div class="flex justify-center items-start min-h-screen p-10">
        <div class="shadow-lg rounded-lg p-10 max-w-lg text-center" style="background-color: rgb(66, 66, 66);">
            ...
            <p class="text-gray-300 mb-6">
                Mūsu komanda kuru vadīja Gustavs un mūsu labākie programmētāji kā Matiss, Elvis, Kristaps un mūsu special needs komandas biedrs Marsels izveidoja šo mājas lapu.
            </p>
